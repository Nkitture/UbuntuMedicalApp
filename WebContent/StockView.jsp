...
<!-- 		Email:xxxxxxxxxxxxxxxxxxx@gmail.com -->
   ...
   <center>ADD/UPDATE/DELETE STOCK HERE</center>
    <button id="b1" data-src="AddNewStock.jsp" onClick="loadFrame(this)">ADD NEW STOCK</button>
    <button id="b2" data-src="UpdateStock.jsp" onClick="loadFrame(this)">UPDATE STOCK</button>
    <button id="b3" data-src="RemoveStock.jsp" onClick="loadFrame(this)">REMOVE STOCK</button>
    <button id="b4" data-src="ViewStock.jsp" onClick="loadFrame(this)">VIEW STOCK</button>
