...
<!-- 		Email:xxxxxxxxxxxxxxxxxxx@gmail.com -->
   ...
   <center>ADD/DELETE COMPANY DETAIL HERE !!</center>
   
    <button id="b1" data-src="AddCompany.jsp" onClick="loadFrame(this)">ADD COMPANY</button>
    <button id="b2" data-src="RemoveCompany.jsp" onClick="loadFrame(this)">REMOVE COMPANY</button>
    <button id="b3" data-src="CompanyList.jsp" onClick="loadFrame(this)">COMPANY LIST</button>
