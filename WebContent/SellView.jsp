...
<!-- 		Email:xxxxxxxxxxxxxxxxxxx@gmail.com -->
   ...
   <center>SELECT CLIENT HERE !!</center>
   
    <button id="b1" data-src="ExistingClient.jsp" onClick="loadFrame(this)">EXISTING CLIENT</button>
    <button id="b2" data-src="NonExistingClient.jsp" onClick="loadFrame(this)">NON-EXISTING CLIENT</button>
    <iframe id="frame1" scrolling="yes" height="400" width="600"></iframe> 
